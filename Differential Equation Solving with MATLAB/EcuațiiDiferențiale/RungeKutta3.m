function [X,Y]=RungeKutta3(f,a,b,y0,n) %Apelul si declararea functiei
...
for i=2:(length(t))
    ...
    k3=h*f(X(i-1,1)+h,Y(i-1,1)-k1+2*k2);
 % Aflarea valorilor functiei in x
  Y(i,1)=Y(i-1,1)+(k1+4*k2+k3)/6;
end
Y
...
%Runge-Kutta de ordin 3 cu rosu
